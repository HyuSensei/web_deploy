...
$sql1  = "SELECT SUM(price) AS 'total price' FROM products WHERE price>0;";
$result1 = mysqli_query($connect, $sql1);

$sql2 = "SELECT date, rate FROM rating";
$result2 = mysqli_query($connect, $sql2);

$sql3 = "SELECT COUNT(order_status) as total FROM orders WHERE order_status = 0;";
$result3 = mysqli_query($connect, $sql3);

$sql4 = "SELECT COUNT(order_status) as total FROM orders WHERE order_status = 1;";
							...
							<div class="card-body d-flex">
								...
								<div>
									<?php if (is_array($result) || is_object($result)) foreach ($result as $value) : ?>
										<h2 class="text-white invoice-num"><?php echo $value['id'] ?></h2>
										<span class="text-white fs-18">Tổng số sản phẩm</span>
									<?php endforeach ?>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<?php if (is_array($result1) || is_object($result1)) foreach ($result1 as $value) : ?>
										<h2 class="text-white invoice-num"><?php echo $value['total price'] ?>đ</h2>
										<span class="text-white fs-18">Tổng tiền</span>
									<?php endforeach ?>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<?php if (is_array($result3) || is_object($result3)) foreach ($result3 as $value) : ?>
										<h2 class="text-white invoice-num"><?php echo $value['total'] ?></h2>
										<span class="text-white fs-18">Đơn hàng chưa duyệt</span>
									<?php endforeach ?>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<?php if (is_array($result4) || is_object($result4)) foreach ($result4 as $value) : ?>
										<h2 class="text-white invoice-num"><?php echo $value['total'] ?></h2>
										<span class="text-white fs-18">Đơn hàng đã duyệt</span>
									<?php endforeach ?>
								</div>
							</div>
						</div>
