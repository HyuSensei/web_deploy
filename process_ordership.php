...
if (isset($_SESSION['id'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
                ...
                echo '
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="row">
                                         <div class="col-6">
                                            <a href="process_order_receive.php?id=' . $row['id_order'] . '"><button style="font-size: 15px;background-color: #820813" type="button" id="show-confirm" class="btn btn-info">Đã Nhận</button></a>
                                         </div>
                                         <div style="margin-left: -70px;" class="col-6">
                                            <a href=""><button style="font-size: 15px;margin-left: 10px;background-color: white;color: gray" type="button" class="btn btn-info">Liên Hệ</button></a>
                                         </div>
                                    </div>
                                </div>
                            </div>
        ...
        echo '<div class="container"><p style="font-size: 20px;font-weight: bold;">Chưa có đơn hàng đang vận chuyển</p></div>';
    }
}
